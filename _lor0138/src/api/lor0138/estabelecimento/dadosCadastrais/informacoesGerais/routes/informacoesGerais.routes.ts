// src/api/lor0138/estabelecimento/dadosCadastrais/informacoesGerais/routes/informacoesGerais.routes.ts
...
import { estabelecimentoParamsSchema } from '../validators/informacoesGerais.validators';

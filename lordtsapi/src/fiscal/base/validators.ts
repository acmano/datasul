/**
 * Validators - Fiscal Base
 *
 * Validação de entrada para endpoints de dados básicos de Fiscal
 *
 * Em desenvolvimento
 */
 ...
 */
export const fiscalBaseParamsSchema = Joi.object({
 ...
 */
export function validateFiscalBaseParams(params: unknown): ValidationResult {
  const { error, value } = fiscalBaseParamsSchema.validate(params, {
    abortEarly: false,
    stripUnknown: true,
  });

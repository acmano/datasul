 ...
 * Validators - PCP Base
 *
 * Validação de entrada para endpoints de dados básicos de PCP
 *
 * Em desenvolvimento
 */
 ...
 */
export const pcpBaseParamsSchema = Joi.object({
 ...
 */
export function validatePCPBaseParams(params: unknown): ValidationResult {
  const { error, value } = pcpBaseParamsSchema.validate(params, {
    abortEarly: false,
    stripUnknown: true,
  });

SELECT  o."it-codigo"        as itemCodigo
  ...
  INNER JOIN pub."grup-maquina" gm
    ON  gm."gm-codigo" = gme."gm-codigo"
  INNER JOIN pub."centro-custo" cc
    ON  cc."cc-codigo" = gme."cc-codigo"
  INNER JOIN pub.item i
    ON  i."it-codigo" = o."it-codigo"
  WHERE o."it-codigo" = ?
    AND o."tipo-oper" <> 2

/**
 * Validators - Manufatura Base
 *
 * Validação de entrada para endpoints de dados básicos de Manufatura
 *
 * Em desenvolvimento
 */
 ...
 */
export const manufaturaBaseParamsSchema = Joi.object({
 ...
 */
export function validateManufaturaBaseParams(params: unknown): ValidationResult {
  const { error, value } = manufaturaBaseParamsSchema.validate(params, {
    abortEarly: false,
    stripUnknown: true,
  });

...
import { LayeredCacheAdapter } from './adapters/LayeredCacheAdapter';
...
export class CacheManager {
   ...
   * @param strategy - Estratégia: memory/redis/layered
   */
  ...
  static getStats(): CacheStats {
    ...
    return { enabled: true, strategy: this.strategy };
  }

  /**
   * Fecha conexões (graceful shutdown)
   */

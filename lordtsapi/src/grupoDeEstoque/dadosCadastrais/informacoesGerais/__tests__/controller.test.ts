...
import { GrupoDeEstoqueNotFoundError, ValidationError } from '@shared/errors/CustomErrors';

jest.mock('../service');

describe('Controller - InformacoesGeraisController (GrupoDeEstoque)', () => {
  ...
  describe('getInformacoesGerais - Sucesso', () => {
    it('deve retornar 200 com dados', async () => {
      ...
      mockRequest.params = { grupoDeEstoqueCodigo: 'TEST123' };

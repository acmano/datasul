...
export const familiaComercialParamsSchema = Joi.object({
  familiaComercialCodigo: secureAlphanumericSchema(1, 16).messages({
...
export function validateFamiliaComercialInformacoesGeraisRequest(
  ...
  if (
    ...
    'familiaComercialCodigo' in params &&
    (params as { familiaComercialCodigo: string }).familiaComercialCodigo === ''
  ) {
    return {
      valid: false,

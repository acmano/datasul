-- ============================================================================
-- Query: Buscar Estabelecimentos do Item (ODBC - Banco EMP)
-- ============================================================================
-- Descrição:
--   Busca relação item x estabelecimento do banco EMP
--   JOIN com estabelec (MULT) será feito em TypeScript
--
-- Parâmetros:
--   ? (varchar) - Código do item a ser buscado (parâmetro ODBC)
--
-- Utilizado por:
--   - item/dadosCadastrais/informacoesGerais/repository.ts :: getItemEstabelecimentos()
--
-- Performance:

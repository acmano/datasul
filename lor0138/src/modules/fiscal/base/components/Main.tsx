// src/modules/fiscal/base/components/Main.tsx
...
interface FiscalProps {
  ...
  onDataLoaded?: (data: ItemFiscal | null) => void;
}

const Fiscal: React.FC<FiscalProps> = ({ selectedItem, preloadedData, onDataLoaded }) => {
  ...
  // Notificar o parent component quando os dados fiscais mudarem
  useEffect(() => {
    if (onDataLoaded) {
      onDataLoaded(fiscal);
    }

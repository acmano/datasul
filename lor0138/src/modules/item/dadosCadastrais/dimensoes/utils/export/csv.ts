// src/modules/item/dadosCadastrais/dimensoes/utils/export/csv.ts

import { ItemDimensoes } from '../../types';

export const exportDimensoesToCSV = (
  ...
  link.setAttribute('download', `${filename}_${dimensoes.itemCodigo}_${timestamp}.csv`);

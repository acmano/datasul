// src/modules/item/dadosCadastrais/manufatura/components/Main.tsx
...
const Manufatura: React.FC<ManufaturaProps> = ({ selectedItem, preloadedData }) => {
  ...
  useEffect(() => {
    ...
    fetchManufatura();
  }, [selectedItem?.itemCodigo, preloadedData, manufatura]);

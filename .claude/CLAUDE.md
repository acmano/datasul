...
6. ❌ **Use localhost or the server's ip address as a part of any URL**
.
...
1. **IMMEDIATELY** analyse to context and relevant fileas anض code to understand the context
2. **IMMEDIATELY** use TodoWrite to create comprehensive todo list
3. Show the todo list to user and the consequences of implementation
4. **IMMEDIATELY** invoke coder with first todo item
